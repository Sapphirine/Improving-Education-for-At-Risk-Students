...
d3.divgrid = function(config) {
  ...
  var dg = function(selection) {
    ...
    var cells = selection.selectAll(".row").selectAll(".cell")
        .data(function(d) { return columns.map(function(col,i){if(i==0) return "<a href=\"javascript:parent.window.location.href='studentDetail.html?studentId=" + d[col] + "';\">" + d[col] + "</a>"; else return d[col];}) })
